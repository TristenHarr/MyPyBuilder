...
class DemoGui(object):
    ...
    def command_share(self, demo, command):
        """
    ...
    @staticmethod
    def make_notebook_tab(self, frame_kwargs, frame_components, frame, tab_demo):
        """
        ...
        self.window.containers[frame].containers['notebook'].add_tab(window, tab_demo)
